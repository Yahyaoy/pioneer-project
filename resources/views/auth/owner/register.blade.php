              ...
              <div class="card shadow-2-strong" style="border-radius: 1rem;">
                <form action="{{ route('owner.register') }}" method="POST">
                    ...
                    <div class="card-body p-5 text-center">
                        <h3 class="mb-5">Register For Owner</h3>
                        ...
                        <div class="form-outline mb-4">
                            <input type="number" name="phone" id="typeEmailX-2" class="form-control form-control-lg" />
                        ...
                        <div class="form-check d-flex justify-content-start mb-4">
                          ...
                          <label class="form-check-label" for="form1Example3">Already have an account ? <a href="{{ route('owner.login') }}">login now </a> </label>
                        </div>
                        </div>
